                                        ...
                                        <li key={item.name} className="flex flex-col">
                                            <div className="flex items-center">
                                                <Link
                                                    href={item.href}
                                                    onClick={onClose}
                                                    className={`group flex items-center gap-2.5 px-2.5 py-1.5 rounded-md text-xs font-medium transition-all flex-1 ${active
                                                ...
                                                {item.hasSubmenu && (
                                                    <button
                                                        onClick={() => {
                                                            if (item.menuKey === "payroll") {
                                                                setPayrollMenuOpen(!payrollMenuOpen);
                                                            } else {
                                                                setTimeOffMenuOpen(!timeOffMenuOpen);
                                                            }
                                                        }}
                                                    ...
                                                    >
                                                        <ChevronDown
                                                            className={`w-3.5 h-3.5 transition-transform ${
                                                                (item.menuKey === "payroll" ? payrollMenuOpen : timeOffMenuOpen) ? "rotate-180" : ""
                                                            }`}
                                                        />
                                                    </button>
                                                )}
                                            ...
                                            {/* Submenu for Time Off and Payroll */}
                                            {item.hasSubmenu && (item.menuKey === "payroll" ? payrollMenuOpen : timeOffMenuOpen) && (
                                                    ...
                                                    {item.subItems.map((sub: { name: string; href: string }) => {
                                                        ...
                                                        return (
                                                            <Link
                                                                ...
                                                                href={sub.href}
                                                                onClick={onClose}
                                                                className={`block px-2 py-1 rounded text-[11px] font-medium transition-colors ${subActive
