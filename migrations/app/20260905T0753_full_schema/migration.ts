#!/usr/bin/env -S node
import type { Contract as Start } from '../../snapshots/88c16d97308923b9c833f8161ca4b37052cb948af8a0df58768b139e01cd5bde/contract';
import startContract from '../../snapshots/88c16d97308923b9c833f8161ca4b37052cb948af8a0df58768b139e01cd5bde/contract.json' with { type: 'json' };
import type { Contract as End } from '../../snapshots/ab438dd23aeb4f3f6c565f9a36785fe786ff00979c2c643514fa28b22c72ff14/contract';
import endContract from '../../snapshots/ab438dd23aeb4f3f6c565f9a36785fe786ff00979c2c643514fa28b22c72ff14/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
    ...
    return [
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('checkOut', 'timestamptz', { codecRef: { codecId: 'pg/timestamptz-temporal@1' } }),
          col('correctedAt', 'timestamptz', { codecRef: { codecId: 'pg/timestamptz-temporal@1' } }),
